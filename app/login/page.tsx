        ...
        <div className="space-y-8 max-w-md">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/20 bg-primary/10 text-xs font-semibold text-primary">
              <ShieldCheck className="h-3.5 w-3.5" /> Enterprise Email Infrastructure
            </div>
            <h1 className="text-3xl font-extrabold tracking-tight text-foreground leading-snug">
              Full control over your mail delivery and event ticketing.
            </h1>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Connect your own SMTP relay, run pre-send domain verification, and monitor real-time engagement telemetry without third-party vendor lock-in.
            </p>
          </div>
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-center gap-3 text-xs text-muted-foreground">
              ...
              <span>99.98% deliverability with zero per-email markup</span>
            </div>
            <div className="flex items-center gap-3 text-xs text-muted-foreground">
              <div className="h-5 w-5 rounded-full bg-emerald-500/10 text-emerald-500 flex items-center justify-center shrink-0">
                <Check className="h-3.5 w-3.5" />
              </div>
              <span>Dynamic QR passes & offline-ready gate scanner PWA</span>
            </div>
            <div className="flex items-center gap-3 text-xs text-muted-foreground">
              <div className="h-5 w-5 rounded-full bg-emerald-500/10 text-emerald-500 flex items-center justify-center shrink-0">
                <Check className="h-3.5 w-3.5" />
              </div>
              <span>End-to-end TLS 1.3 encryption and automated quarantine</span>
            </div>
          </div>
        </div>
