...
export default function AdminSmtpPage() {
  ...
  return <div className="space-y-5">
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <h2 className="text-2xl font-semibold">Global SMTP</h2>
      <div className="flex items-center gap-2 rounded-full border border-zinc-850 bg-zinc-900/50 px-3.5 py-1 text-sm shrink-0">
        <span className="text-xs font-medium text-muted-foreground">
          {mode ? "Global Override" : "Per-User SMTP"}
        </span>
        <Switch
          checked={mode}
          className="scale-75"
