...
export default function AdminUsersPage() {
  ...
  async function create(formData: FormData) {
    ...
    await apiFetch("/api/admin/users", { method: "POST", body: JSON.stringify({ name: formData.get("name"), email: formData.get("email"), password, role: formData.get("role"), dailyLimit: Number(formData.get("dailyLimit") || 200), monthlyLimit: Number(formData.get("monthlyLimit") || 2000) }) });
